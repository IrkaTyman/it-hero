...
import { findActiveHackathon, findUpcomingHackathon } from "@/api/hackathon.ts";
                    ...
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                        {activeHackathon.map((hackathon) => (
                            <Card key={hackathon.id}
                                ...
                                <div
                                    className="h-64 bg-gradient-to-r from-primary/20 to-primary/10 flex items-center justify-center">
                                    <img
                        ...
                        {userTeam ? (
                            ...
                            <div className="text-center py-6 space-y-4">
                                ...
                                <div>
                                    ...
                                    <Button asChild>
                                        <Link to="/team?create=1">Создать команду</Link>
                                    </Button>
                                </div>
                            </div>
                        )}
                            ...
                            <div className="space-y-4">
                                {upcomingHackathon.map((hackathon) => (
                                    <div key={hackathon.id}
                                        ...
                                        <div
                                            className="h-12 w-12 rounded bg-primary/10 flex items-center justify-center">
